  ...
  en: {
    ...
    layers: [
      ...
      },
      {
        ...
        features: ["Structured company knowledge, accessible to AI", "A digital assistant for every employee", "Every fact with an owner and a refresh date", "Integration with existing systems", "Continuous updates: a living system, not a one-time snapshot"],
