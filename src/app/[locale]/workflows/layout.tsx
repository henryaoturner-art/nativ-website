...
const copy = {
  nl: {
    title: "AI-workflows voor het mkb — praktische hulp per klus | nativ",
    description:
  ...
  en: {
    title: "AI workflows for SMEs: practical help per task | nativ",
    description:
      "An AI workflow takes one recurring task off your hands, start to finish, working from your Company Brain. Examples for marketing, sales, finance and HR. Start with the free scan to see which ones fit you.",
  },
};

export async function generateMetadata({ params }: { params: Params }): Promise<Metadata> {
  const { locale } = await params;
  return localizedPageMeta(isLocale(locale) ? locale : "nl", "/workflows", copy);
}
