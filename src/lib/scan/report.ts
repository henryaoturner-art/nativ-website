...
- watErvoorInDePlaatsKomt: hooguit 45 woorden. Niemand hoeft over te stappen en niemand hoeft buiten te blijven: wie in zijn eigen AI-tool wil blijven werken koppelt die aan de vastgelegde kennis, wie liever in één omgeving werkt doet dat in het platform. Twee even normale opties. Wat in beide gevallen verandert is waar de context vandaan komt. Geen opsomming van wat er dan allemaal kan.
