...
const translations = {
  en: {
    ...
    quote: '"Company brain: making company knowledge usable for AI: minimum viable context (MVC™). The theory and the practice."',
    discover: 'In this paper you\'ll discover:',
    bullet1: 'Why 80% of AI projects fail, and it\'s not the model',
    bullet2: 'The MVC™ framework: eleven knowledge areas with over four hundred categories',
    bullet3: 'Governance: every fact with an owner, a shelf life, and access rules',
    bullet4: 'From company brain to AI workflows, and how you start',
  ...
  nl: {
    ...
    quote: '"Company brain: bedrijfskennis bruikbaar maken voor AI: minimum viable context (MVC™). De theorie en praktijk."',
    discover: 'In dit paper ontdek je:',
    bullet1: 'Waarom 80% van AI-projecten faalt, en het ligt niet aan het model',
    bullet2: 'Het MVC™-framework: elf kennisgebieden met ruim vierhonderd categorieën',
    bullet3: 'Governance: elk feit met een eigenaar, een houdbaarheidsdatum en toegangsregels',
    bullet4: 'Van company brain naar AI-workflows, en hoe je begint',
